            ...
            results.append(
                {
                    ...
                    # Reflects effective_price (promo when there is one),
                    # same as RecipeIngredient.store_costs/line_cost and
                    # Recipe.current_cost — this is what buying it here
                    # actually costs right now, not necessarily `price` above.
